...
--
-- Host: localhost
-- Generation Time: May 01, 2020 at 04:54 PM
...
--
ALTER TABLE `CARD`
  ADD CONSTRAINT `CARD_ibfk_1` FOREIGN KEY (`PaymentID`) REFERENCES `PAYMENT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `CASH`
--
ALTER TABLE `CASH`
  ADD CONSTRAINT `CASH_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `PAYMENT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `TICKET`
  ADD CONSTRAINT `TICKET_ibfk_1` FOREIGN KEY (`AFM`) REFERENCES `CUSTOMER` (`AFM`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TICKET_ibfk_2` FOREIGN KEY (`PaymentID`) REFERENCES `PAYMENT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TICKET_ibfk_3` FOREIGN KEY (`FlightID`) REFERENCES `FLIGHT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `TRIP`
--
ALTER TABLE `TRIP`
  ADD CONSTRAINT `TRIP_ibfk_1` FOREIGN KEY (`AFM`) REFERENCES `CUSTOMER` (`AFM`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
